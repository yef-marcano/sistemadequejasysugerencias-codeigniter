...

{
    ...
    public $v_fields=array('nombrecompleto', 'telefono', 'direccion', 'tipo', 'mensaje', 'fueleido', 'creado_fecha', 'departamento.nombre');
	...
	function getList($table, $pagination=array()) {
        ...
        $this->db->select("$table.*  , departamento.nombre as departamento_id ");

        $this->db->from($table);

         $this->db->join("departamento", "items.departamento_id = departamento.id", "left");     
