...
<head>
	<title>Add New</title>
	<link href="<?php echo $this->config->item('accet_url') ?>vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css">
</head>
<body>
	<div class="container">
	...
	<script type="text/javascript" src="<?php echo $this->config->item('accet_url') ?>vendor/jquery/jquery-3.2.1.min.js"></script>
