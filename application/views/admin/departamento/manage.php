   ...
   <div class="col-lg-12">
      ...
      <div class="ibox ">
         ...
         <div class="ibox-title">
            ...
            <a href="<?php echo base_url(); ?>admin/departamento/add" class="btn btn-info">AGREGAR NUEVO</a>
         ...
         <div class="table table-responsive">
		   ...
		   <a href="<?php echo base_url()?>admin/departamento/view/<?php echo $value->id; ?>" title="View">

            <span class="btn btn-info " ><i class="fa fa-eye"></i></span>

           </a>

           <a href="<?php echo base_url()?>admin/departamento/edit/<?php echo $value->id; ?>" title="Edit">

            <span class="btn btn-info " ><i class="fa fa-edit"></i></span>

           </a>

           <a  title="Delete" data-toggle="modal" data-target="#commonDelete" onclick="set_common_delete('<?php echo $value->id; ?>','departamento');">
