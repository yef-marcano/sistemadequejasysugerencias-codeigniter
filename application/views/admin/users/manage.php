   ...
   <div class="col-lg-12">
      <div class="ibox ">
         ...
         <div class="ibox-title">
            ...
            <?php endif; ?>
            <a href="<?php echo base_url(); ?>admin/users/add" class="btn btn-info">ADD NEW</a>
            ...
            <form method="GET" action="<?php echo base_url().'admin/users/index'; ?>" class="form-inline ibox-content">
               <div class="form-group">
                  ...
                  <option value="password" <?php echo $searchBy=="password"?'selected="selected"':""; ?>>Password</option><option value="email" <?php echo $searchBy=="email"?'selected="selected"':""; ?>>Email</option><option value="first_name" <?php echo $searchBy=="first_name"?'selected="selected"':""; ?>>First_name</option><option value="last_name" <?php echo $searchBy=="last_name"?'selected="selected"':""; ?>>Last_name</option><option value="company" <?php echo $searchBy=="company"?'selected="selected"':""; ?>>Company</option><option value="phone" <?php echo $searchBy=="phone"?'selected="selected"':""; ?>>Phone</option>
                  </select>
               </div>
               <div class="form-group">
